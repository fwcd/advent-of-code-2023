    ...
    [path] -> do
      ...
      let input  = mapMaybe parseHailstone (lines raw)
          ...
          -- The unknowns:         (p 0).x             (p 0).y             (p 0).z           (v 0).x            (v 0).y            (v 0).z
                      { a = [ [0                , (v 2).z - (v 1).z, (v 1).y - (v 2).y, 0                , (p 1).z - (p 2).z, (p 2).y - (p 1).y]
                            ...
                            , [(v 2).y - (v 1).y, (v 1).x - (v 2).x, 0                , (p 1).y - (p 2).y, (p 2).x - (p 1).x, 0                ]
                            , [(v 3).y - (v 1).y, (v 1).x - (v 3).x, 0                , (p 1).y - (p 3).y, (p 3).x - (p 1).x, 0                ]
                            ]
                      , b = [ (p 1).z * (v 1).y - (p 1).y * (v 1).z + (p 2).y * (v 2).z - (p 2).z * (v 2).y
                            ...
                            , (p 1).y * (v 1).x - (p 1).x * (v 1).y + (p 2).x * (v 2).y - (p 2).y * (v 2).x
